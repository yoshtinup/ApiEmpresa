...
export class ProductoController {
  ...
  async updateProductoById(req, res) {
    try {
      ...
      if ( !productoData.nombre || !productoData.ciudad || !productoData.fecha_inicial || !productoData.fecha_final) {
  ...
  async createProducto(req, res) {
    try {
      ...
      const { nombre, ciudad, fecha_inicial, fecha_final} = req.body;
      ...
      const newDatos = await this.createBoletoUseCase.execute(productoData);
